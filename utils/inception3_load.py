...
def init(H, config=None):
    ...
    graph_def_orig_file = '%s/../model/inception3.pb' % os.path.dirname(os.path.realpath(__file__))
...
def model(x, googlenet, H):
    ...
    coarse_feat = T['inception_v3_1/mixed_8x8x2048b/concat']

    # fine feat can be used to reinspect input
    attention_lname = H.get('attention_lname', 'inception_v3_1/conv4/Relu')
